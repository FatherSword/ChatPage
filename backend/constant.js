...
const MESSAGES = {
    DEFAULT: (msg = "") => `${msg ? msg : ""}`,
    MODEL_ADDED: (model = "") => `The model '${model}' has been added successfully.`,
    MODEL_DELETED: (model = "") => `The model '${model}' has been deleted successfully.`
};

const WEBHOOK_MESSAGES = {
    DEFAULT: (username = "") => username ? `New user signed up: ${username}` : "New user signed up"
};
...
const ERROR_MESSAGES = {
    ...
    INCORRECT_FORMAT: (err = "") => `Invalid format. Please use the correct format${err}`,
    RATE_LIMIT_EXCEEDED: "API rate limit exceeded",
    MODEL_NOT_FOUND: (name = "") => `Model '${name}' was not found`,
    OPENAI_NOT_FOUND: (name = "") => `OpenAI API was not found`,
